...
1. Make sure you have a vision-capable model loaded — see [`../prep/setup-guide.md`](../prep/setup-guide.md) for **Moondream2** (lightweight default) or **Qwen2-VL 7B Instruct** (heavier alternative). If the loaded model is text-only, LM Studio will not show the image-attach button.
...
**Setup:** see [`../prep/setup-guide.md`](../prep/setup-guide.md) for installation and the recommended models (**Moondream2** for photos, **Qwen 2.5 7B** for text).
